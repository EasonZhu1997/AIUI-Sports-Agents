// Keep AIUI JSON responses deterministic across host versions. Requests set
// responseType=text and dataType=json, while this decoder also accepts an older
// host returning text or bytes despite those explicit options.
