...
AIUI Sports Agents is an evidence-first open-source benchmark and governance hub for sports agents on smart glasses. The application source planned for AISmartRun, AIBike, and AISmartRower is a separate source-available distribution, not an OSI open-source grant.
