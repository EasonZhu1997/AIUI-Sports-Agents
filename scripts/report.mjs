...
console.log('| Project | Sport | Track | Version | Evidence | Common | Sport | Open gates |');
console.log('|---|---|---|---|---|---|---|---:|');
...
for (const project of registry.projects) {
  ...
  console.log(`| ${project.name} | ${project.sport} | ${project.status} | ${project.version} | ${result.evidenceLevel} | ${summarize(result.common)} | ${summarize(result.sportSpecific)} | ${result.openGates.length} |`);
}

console.log('\nLegend: P=pass, ~=partial, B=blocked, N=not run. Every status is bounded by the listed evidence level.');
